...
const FilterPopup = ({ isVisible, closePopup, onApplyFilters }) => {
    ...
    return (
        <div className="overlay fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center" onClick={closePopup}>
            <div className="bg-white rounded-lg shadow-lg w-[80%] lg:w-[25%] p-6 space-y-6 relative" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-between pb-4">
                    <p onClick={closePopup} className="text-gray-600 text-sm font-bold cursor-pointer hover:text-gray-800">Cancel</p>
                    <h2 className="text-black text-2xl font-semibold">Filter Products</h2>
                    <p onClick={clearAll} className="text-red-500 text-sm font-bold cursor-pointer hover:text-red-700">Clear All</p>
                </div>
