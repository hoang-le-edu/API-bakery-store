            ...
            {showSuccess ? (
                <div className="flex flex-col h-full w-full justify-center items-center mt-55">
                    ...
                    <span className="text-xl mt-4 flex flex-col items-center">
                        {socketStatus ? 'Pay successfully!' : 'Place order successfully!'}
                        {showPaynowButton && 'Please pay the order to proceed, you can pay now or later!'}
                    </span>
                    {showButtons && (
                                    ...
                                    <div className="space-y-1 p-5 pt-4">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="grid grid-cols-1 gap-2">
                                                <div>
                                                    <label
                                                        className="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Receiver
                                                        Name</label>
                                                ...
                                                <div>
                                                    <label
                                                        className="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Phone
                                                        Number</label>
                                                ...
                                                <div>
                                                    <label
                                                        className="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Note</label>
                                                ...
                                                <div>
                                                    <label
                                                        className="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Payment
                                                        Method</label>
