            ...
            <div className="bg-white rounded-lg shadow-lg w-[1300px] h-[600px] relative flex z-9999"
                ...
                <div className="flex flex-col w-[700px] pr-6 pl-6 pt-4 pb-2">
                        ...
                        <div className="w-full flex flex-col justify-start mb-2">
                            ...
                            <div className="mb-4">
                                <div className="flex justify-between items-center mb-2">
                                    <p className="text-black font-semibold text-lg">Size</p>
                                </div>
                            ...
                            {/*Topping */}
                            <div className="mb-5">
                                <p className="text-black font-bold text-lg mb-2">Topping</p>
                                <div className="flex space-x-4">
                                    {selectedProduct?.topping_list.length !== 0 ? (
                                        ...
                                        <span>No topping available</span>
                                    )}
                                </div>
                            </div>
                            ...
                            {/*Note */}
                            <div className="mb-4">
                                <p className="text-black font-bold text-lg mb-2">Note</p>
                    ...
                    <div className="flex justify-end items-center space-x-4 h-[10%]">
                        <div>
                            <span className="mr-3">
                                Total: {totalPrice.toLocaleString('vi-VN', {style: 'currency', currency: 'VND'})}
                            </span>
                            {!isEdit ? (
                                <button onClick={addToCart}
                                        className="bg-[#f26d78] text-white px-4 py-2 rounded-full font-bold">
                                    {/*Add to cart*/}
                                    {loading ? <SpinnerLoading/> : 'Add to cart'}
                                </button>
                            ) : (
